...
export default async function Actorcard({ params }) {
  ...
  return (
    <div className="flex flex-col items-center gap-5 p-5 bg-gradient-to-r from-[#000814] from-10% via-[#001d3d] via-30% to-[#000814] to-90% ... text-white">
      <div className="max-w-7xl w-full mx-auto p-4 flex flex-col items-center md:flex-row md:items-start md:space-x-10 mb-12">
        <div className='md:w-1/2 p-4 flex justify-center md:justify-start items-center sm:w-3/4 md:mt-1'>
        ...
        <div className="md:w-1/2 mt-4 md:w-3/4 sm:w-full">
          <div>
