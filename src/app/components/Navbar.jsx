...
<div className="relative">
    <button onClick={toggleGenres} className="block mt-2 px-3 py-2 text-white bg-yellow-500 rounded-md hover:bg-yellow-600">
    ...
    {showGenres && (
        ...
        <ul className="flex flex-col md:flex-row items-center p-4 md:p-0 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
                <button className="block mt-2 px-3 py-2 text-gray-900 rounded-md hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
